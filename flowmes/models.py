...
class User(UserMixin, db.Model):
    ...
    school = db.Column(db.String(140), default="No data")
    hometown = db.Column(db.String(140), default="No data")
    location = db.Column(db.String(140), default="No data")
    relationship = db.Column(db.String(140), default="No data")
