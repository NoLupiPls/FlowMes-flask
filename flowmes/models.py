...
class User(UserMixin, db.Model):
    ...
    about_me = db.Column(db.String(140), default='Cкрыто')
    last_seen = db.Column(db.DateTime, default=datetime.utcnow)
    school = db.Column(db.String(140), default="Cкрыто")
    hometown = db.Column(db.String(140), default="Cкрыто")
    location = db.Column(db.String(140), default="Cкрыто")
    relationship = db.Column(db.String(140), default="Cкрыто")
